...
async function seed() {
    ...
    const australianUniversities = require('../../../australian_universities_seed.json');
    const canadianUniversities = require('../../../canadian_universities_seed.json');
